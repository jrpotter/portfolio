...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Component.PostList"] = $PS["Component.PostList"] || {};
  var exports = $PS["Component.PostList"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var handleAction = function (v) {
      ...
      throw new Error("Failed pattern match at Component.PostList (line 35, column 16 - line 37, column 45): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var Component_PostList = $PS["Component.PostList"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Component_PostList.component)(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();